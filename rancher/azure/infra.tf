...
# Storage Account for k3s cluster
# resource "azurerm_storage_account" "rancher-quickstart" {
#   name                     = "${var.prefix}sa"
...
# Storage Container for k3s cluster
# resource "azurerm_storage_container" "rancher-quickstart" {
#   name                  = "${var.prefix}container"
#   resource_group_name   = azurerm_resource_group.rancher-quickstart.name
#   storage_account_name  = azurerm_storage_account.rancher-quickstart.name
...
# Blob for SSH files
# resource "azurerm_storage_blob" "rancher-quickstart" {
#   name = "${var.prefix}blob"
#   resource_group_name    = azurerm_resource_group.rancher-quickstart.name
#   storage_account_name   = azurerm_storage_account.rancher-quickstart.name
#   storage_container_name = azurerm_storage_container.rancher-quickstart.name
#   type = "Block"  
